...
Các chủ đề trong 3 nhóm đầu có thể nói độc thoại trong khoảng 15-30 phút. Phần lớn các chủ đề ở đây đã có bài viết và có thể nói được ngay. Nếu người tham gia đọc trước bài viết thì không cần vào nghe. Tất nhiên nếu nghe thêm thì sẽ tốt hơn, do não sẽ có thêm cơ hội để liên kết ý tưởng và nảy ra câu hỏi đào sâu. 

Những gì được nói trong thời gian này không nhất thiết là toàn bộ những gì có liên quan đến chủ đề. Nhưng trình bày chúng trong phần hỏi đáp thì sẽ hiệu quả hơn. Do các chủ đề cũng liên kết nhiều với nhau nên một buổi thảo luận có thể nói nhiều chủ đề khác nhau. Các câu hỏi cũng thường sẽ là điểm để chuyển sang chủ đề khác. Việc này sẽ tăng sự cá nhân hóa cho người tham gia hơn.

Các chủ đề trong nhóm "Kiến thức liên ngành" thì thường độc lập với nhau và có lẽ cần nhiều thời gian trình bày độc thoại hơn. Tuy nhiên chúng cần chuẩn bị, nghiên cứu thêm, và sự chuẩn bị này có ít liên hệ tới [điều Nhật đang tập trung làm](./Nhu%20c%E1%BA%A7u%20c%E1%BB%A7a%20Nh%E1%BA%ADt.md). Nên Nhật muốn có thời gian để ý tưởng được nảy ra.

Ngoài ra, trong [CV của Nhật](./CV.md) có danh sách đầy đủ về những gì Nhật biết hơn. Các chủ đề đó nếu được hỏi thì vẫn trả lời được, nhưng sẽ bị tủn mủm do chưa sắp xếp các ý thành một cấu trúc.
...
Các quỹ tín dụng vi mô, cộng đồng có chủ đích, câu lạc bộ tiêu dùng

### Chương trình kế toán văn bản thuần 
Các chương trình như Momo, MoneyLover hay các app ngân hàng không linh hoạt trong việc chia tài khoản. Excel thì dễ bị thay đổi dữ liệu mà không ai biết. Nếu bạn đang quản lý quỹ cho nhóm, có thể bạn sẽ thấy các chương trình kế toán văn bản thuần hữu ích cho bạn.
Ghi chép Và Báo cáo Chi tiêu bài bản hơn
